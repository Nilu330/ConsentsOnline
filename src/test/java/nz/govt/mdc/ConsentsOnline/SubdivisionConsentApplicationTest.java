...
import pageObjects.ApplicationStepSeven;
...
public class SubdivisionConsentApplicationTest extends Base 
{ 
	...
	//TC0043|Validate Step1 of the application with Subdivision Consent selection and mandatory fields
	...
	{	 
		...
		as1.post_code("1345");
		as1.resource_consent_type("Subdivision Consent");
	...
	//TC0038|Validate Step 5 of the application without filling mandatory fields if there is any.
	...
	//TC0044|Validate Step 6 of the application without filling mandatory fields if there is any.
	public void application_step_six() 
	{
		...
		log.info("Step 7 displayed");	

	}

	@Test(priority=8, enabled=true)
	//TC0045|Validate Step 7 of the application without filling mandatory fields if there is any.
	public void application_step_seven() 
	{
		ApplicationStepSeven as7=new ApplicationStepSeven(driver);
		as7.step7();
		Assert.assertEquals(driver.getTitle(), "Hazards - Consents Online");
	}

	@Test(priority=8, enabled=true)
	//TC0041|Validate Step 8 of the application with mandatory fields.
